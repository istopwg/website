...
print("</p></div></div>\n"
     ...
     ."<div class=\"panel-body\"><p>Support multiple network protocols and job ticket formats using our abstract model.</p>\n"
     ...
     ."<div class=\"panel-body\"><p>Monitor jobs, status, and supplies, and manage your printers remotely using SNMP.</p>\n"
