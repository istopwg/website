...
INSERT INTO document VALUES(12,10,2,10,'5100.12-2011','2.0','IPP Version 2.0 Second Edition (IPP/2.0 SE)','Since the release of IPP/1.1 (RFC 2910 and RFC 2911), numerous extensions to the IPP protocol have been published as IETF RFCs or PWG Candidate Standards. Many IPP developers are not aware of the existence of many of these extensions, and there is no published document that references all of these extension specifications. As a consequence, only some of the extensions have been implemented.
...
-- 5110.x
INSERT INTO document VALUES(44,0,4,0,'5110.1-2013','1.0','PWG Hardcopy Device Health Assessment Attributes','This standard defines a set of attributes for Hardcopy Devices (HCDs) that may be used in the various network health assessment protocols to measure the fitness of a HCD to attach to the network.','http://ftp.pwg.org/pub/pwg/candidates/cs-idsattributes10-20130401-5110.1.doc','http://ftp.pwg.org/pub/pwg/candidates/cs-idsattributes10-20130401-5110.1.pdf','','2013-04-01 12:00:00',1,'2013-04-01 12:00:00',1);

INSERT INTO document VALUES(45,44,4,0,'5110.1-2014','1.1','PWG Hardcopy Device Health Assessment Attributes','','http://ftp.pwg.org/pub/pwg/candidates/cs-idsattributes10-20140106-5110.1.doc','http://ftp.pwg.org/pub/pwg/candidates/cs-idsattributes10-20140106-5110.1.pdf','','2014-01-06 12:00:00',1,'2014-01-06 12:00:00',1);

INSERT INTO document VALUES(46,45,4,10,'5110.1-2014','1.1','PWG Hardcopy Device Health Assessment Attributes','','http://ftp.pwg.org/pub/pwg/candidates/cs-idsattributes10-20140529-5110.1.doc','http://ftp.pwg.org/pub/pwg/candidates/cs-idsattributes10-20140529-5110.1.pdf','','2014-05-29 12:00:00',1,'2014-05-29 12:00:00',1);

INSERT INTO document VALUES(47,0,4,10,'5110.2-2013','1.0','PWG Hardcopy Device Health Assessment Network Access Protection Protocol Binding (HCD-NAP)','This standard is one part of a set of documentation that defines the application of security policy enforcement mechanisms to imaging devices. This document specifies how the Microsoft Network Access Protection (NAP) protocol is to be used, along with the set of health assessment attributes created especially for HCDs, to allow access to such devices based upon the locally defined security policy.','http://ftp.pwg.org/pub/pwg/candidates/cs-ids-napsoh10-20130401-5110.2.doc','http://ftp.pwg.org/pub/pwg/candidates/cs-ids-napsoh10-20130401-5110.2.pdf','','2013-04-01 12:00:00',1,'2013-04-01 12:00:00',1);

INSERT INTO document VALUES(48,0,4,10,'5110.3-2013','1.0','PWG Common Log Format (PWG-LOG)','This standard defines a common log format for hardcopy device events that can be used with existing logging protocols such as SYSLOG. While the focus of this format is on security and auditing of devices, it also supports logging of arbitrary events such as those defined by the IPP Event Notifications and Subscriptions (RFC 3995) specification.','http://ftp.pwg.org/pub/pwg/candidates/cs-ids-log10-20130401.5110.3.doc','http://ftp.pwg.org/pub/pwg/candidates/cs-ids-log10-20130401.5110.3.pdf','','2013-04-01 12:00:00',1,'2013-04-01 12:00:00',1);

-- Informational
INSERT INTO document VALUES(49,0,1,8,'','','PWG Best Practices for Use of the RepertoireSupported Element','In traditional printing environments, clients rely on font downloads when they are not sure a given character is embedded in the printer. As printing moves to small clients, downloading may not be an option and clients have a need to know what characters are available in a given device.
There are many published named character repertoires, and a small client will not know about them all.
